    ...
    <footer class="footer has-cards">
        ...
        <div class="container">
            <div class="row row-grid align-items-center my-md">
                <div class="col-lg-6">
                    <h3 class="text-primary font-weight-light mb-2">Gracias por hacer de un mundo mejor!</h3>
                    <h4 class="mb-0 font-weight-light">Ayudanos a difundir la iniciativa, juntos podemos lograrlo.</h4>
                </div>
            ...
            <div class="row align-items-center justify-content-md-between">
                <div class="col-md-6">
                    <div class="copyright">
                        &copy; {{year}}
                        <a href="https://www.creative-tim.com" target="_blank" rel="noopener">No Mas Colillas Uruguay</a> Desarrollado por <a href="https://www.binarcode.com" target="_blank" rel="noopener">OutboxDev</a>
                    </div>
                </div>
                <div class="col-md-6">
